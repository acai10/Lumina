// WORKER-ONLY module: imports h5wasm, which must never enter the main-thread
// bundle. Main-thread code uses h5WorkerClient.ts / h5Constants.ts instead.
...
import { VOLUME_DIMS, PRE_FILTER_THRESHOLD } from './h5Constants'
